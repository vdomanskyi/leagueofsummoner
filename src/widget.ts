...
import general from './frames/general.ts'

const _LoS_ = '[League of Summoner]'

const axios = window.axios;

const proxy = axios.create({ baseURL: 'https://jb7wcew52glscncuehjfvlvwfe0xzhgm.lambda-url.eu-north-1.on.aws' });
...
// const requests = {
//   general: {
//     getUser: async function (gameName, tagLine) {
//       const rawPath = `https://${fields.platformRouting}.api.riotgames.com/riot/account/v1/accounts/by-riot-id/${gameName}/${tagLine}?api_key=${fields.API_KEY}`;
//       return proxy.post('', { rawPath });
//     },
//     getCharacterList: async function (summonerId) {
...
//       return proxy.post('', { rawPath });
//     },
//     getSummonerByPUUID: async function (puuid) {
...
//   match: {
//     getMatchList: async function (puuid, count = 7) {
...
//   champion: {
//     getChampionTop: async function (puuid, count = 3) {

...
To obtain your Personal API Key, refer to the step-by-step instructions provided in dist/Text to obtain a personal API key.txt. The file contains all the details needed to securely generate your key from the Riot Developer Portal.

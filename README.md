...
2. **Add Code to StreamElements**
   ...
   - Open this [link](https://cdn.jsdelivr.net/npm/leagueofsummoner@2.3.1/dist/documentation/streamelements.txt). This file contains code snippets that must be copied into specific tabs in StreamElements Overlay.
